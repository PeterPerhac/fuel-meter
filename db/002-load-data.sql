...
VALUES ('2014/01/04', 'NA08MYW', 447.0, 74923, 46.69, 64.39),
       ...
       ('2022/01/15', 'HY13VLV', 336.0, 66152, 41.59, 63.18),
       ('2022/01/29', 'HY13VLV', 160.5, 66313, 26.57, 40.36),
       ('2022/02/13', 'HY13VLV', 264.2, 66577, 38.04, 58.15),
       ('2022/02/26', 'HY13VLV', 304.1, 66881, 43.35, 67.58),
       ('2022/03/12', 'HY13VLV', 207.0, 67088, 28.56, 49.67),
       ('2022/03/26', 'HY13VLV', 189.7, 67272, 26.45, 46.53),
       ('2022/04/03', 'HY13VLV', 134.4, 67406, 21.84, 38.85),
       ('2022/04/14', 'HY13VLV', 229.0, 67635, 31.10, 54.08),
       ('2022/04/15', 'HY13VLV', 220.5, 67856, 24.25, 43.64),
       ('2022/04/18', 'HY13VLV', 126.7, 67983, 16.17, 28.60),
       ('2022/04/23', 'HY13VLV', 340.9, 68324, 37.44, 66.61);
